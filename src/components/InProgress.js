...
const InProgress=()=> {
    ...
    const onPressSave=()=>{
        ...
        const items = (() => {
          ...
          items.push({id: Date.now(),"status": "inprogress", 'name':title, "note": desc})
    ...
    <div className={styles.main}>
        {cardOps ? (
             < div className={cardCon.main}>
                <p style={{fontSize: 12, fontWeight: 'bold', color: "#0096FF"}}>New Task: In progress</p>
                <textarea
                placeholder='Title'
        ...
        {cardEdit ? (
            < div className={cardCon.main}>
            <p style={{fontSize: 12, fontWeight: 'bold', color: "#0096FF"}}>Status: In progress</p>
            <textarea
        ...
        <p style={{fontSize: 12, backgroundColor: '#f6f7d0', fontWeight:'500', paddingRight: 5, paddingLeft: 5, borderRadius: 2, minWidth: 65, marginRight: 5, marginLeft:5}}>In progress</p>
        {todos?
        (
            (         
